...
var file_commonpb_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xcc, 0x06, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x12, 0x3e, 0x0a,
...
var file_commonpb_proto_depIdxs = []int32{
	...
	5,  // 2: commonpb.Backend.IsUserValid:input_type -> commonpb.AccountRequest
	5,  // 3: commonpb.Backend.RegisterNewUser:input_type -> commonpb.AccountRequest
	3,  // 4: commonpb.Backend.isUsernameAvailable:input_type -> commonpb.UsernameRequest
	6,  // 5: commonpb.Backend.IsFollowed:input_type -> commonpb.FollowRequest
	6,  // 6: commonpb.Backend.AddFollow:input_type -> commonpb.FollowRequest
	6,  // 7: commonpb.Backend.RemoveFollow:input_type -> commonpb.FollowRequest
	3,  // 8: commonpb.Backend.GetFollowedUsers:input_type -> commonpb.UsernameRequest
	1,  // 9: commonpb.Backend.GetAllArticles:input_type -> commonpb.Request
	3,  // 10: commonpb.Backend.GetSomeArticles:input_type -> commonpb.UsernameRequest
	2,  // 11: commonpb.Backend.GetArticleByID:input_type -> commonpb.ArticleIDRequest
	3,  // 12: commonpb.Backend.GetArticleByUser:input_type -> commonpb.UsernameRequest
	4,  // 13: commonpb.Backend.CreateNewArticle:input_type -> commonpb.NewArticleRequest
	9,  // 14: commonpb.Backend.IsUserValid:output_type -> commonpb.BoolReply
	9,  // 15: commonpb.Backend.RegisterNewUser:output_type -> commonpb.BoolReply
	9,  // 16: commonpb.Backend.isUsernameAvailable:output_type -> commonpb.BoolReply
	11, // 17: commonpb.Backend.IsFollowed:output_type -> commonpb.IsFollowedReply
	7,  // 18: commonpb.Backend.AddFollow:output_type -> commonpb.Reply
	7,  // 19: commonpb.Backend.RemoveFollow:output_type -> commonpb.Reply
	10, // 20: commonpb.Backend.GetFollowedUsers:output_type -> commonpb.UsernameListReply
	12, // 21: commonpb.Backend.GetAllArticles:output_type -> commonpb.ArticleListReply
	12, // 22: commonpb.Backend.GetSomeArticles:output_type -> commonpb.ArticleListReply
	13, // 23: commonpb.Backend.GetArticleByID:output_type -> commonpb.ArticleReply
	12, // 24: commonpb.Backend.GetArticleByUser:output_type -> commonpb.ArticleListReply
	13, // 25: commonpb.Backend.CreateNewArticle:output_type -> commonpb.ArticleReply
